...
from Smartly.models import Course , Payment , UserCourse , Tag , Prerequisite , Learning , Video
...
class UserCourseAdminModel(admin.ModelAdmin):
    ...
    def get_course(self , usercourse):
        return format_html(f"<a target='_blank' href='/admin/Smartly/course/{usercourse.course.id}'>{usercourse.course}</a>")
